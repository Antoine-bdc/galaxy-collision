...
double dt = 1.e10;                        /// Time step delta t
int n_t = 1000 + 1  ;                             /// Total number of time steps
...
double x_2 = 1.2/2;                      /// initial position x of galaxy 2 / SMBH (in grid length fraction) if applicable
double y_2 = 0.2/2;                      /// initial position y of galaxy 2 / SMBH (in grid length fraction) if applicable
...
double vy_2 = 1.5;                        /// initial global velocity y of galaxy 2 / SMBH(in grid length fraction) if applicable
