...
int second_object = 0;                   /// Presence of additionnal object (0 = None), (1 = galaxy 2), (2 = SMBH)

// Simulation parameters:
double dt = 1e10;                        /// Time step delta t
int n_t = 1000  ;                             /// Total number of time steps
...
int n_stars = 10000;                         /// Total number of stars
double fraction_stars = 1.;              /// Fraction of stars in the galaxy 1
double a1 = 0.1;                         /// Galaxy 1 typical size (in grid length fraction)
double a2 = 0.01;                        /// Galaxy 2 typical size (in grid length fraction) if applicable
...
double x_2 = 1.3/2;                      /// initial position x of galaxy 2 / SMBH (in grid length fraction) if applicable
double y_2 = 1.3/2;                      /// initial position y of galaxy 2 / SMBH (in grid length fraction) if applicable
...
double vx_2 = 0 * 1.e11;                 /// initial global velocity x of galaxy 2 / SMBH(in grid length fraction) if applicable
double vy_2 = 0.;                        /// initial global velocity y of galaxy 2 / SMBH(in grid length fraction) if applicable
